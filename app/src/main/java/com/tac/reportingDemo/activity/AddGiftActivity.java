...
import com.tac.reportingDemo.adapter.AddGiftAdapter;
...
public class AddGiftActivity extends AppCompatActivity {
    ...
    private AddGiftAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AddGiftAdapter(this, mList);
    ...
    private void fetchProducts() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, ENDPOINTS.GET_GIFTS, new Response.Listener<String>() {
            @Override
                ...
                try {
                    if (JsonParsor.isReqSuccesful(response)) {
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            pojo.setName(data.getString("GiftName"));
                            pojo.setId(data.getString("GiftId"));
                            mList.add(pojo);
                        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AddGiftActivity.this, BillingActivity.class));
    }
}
