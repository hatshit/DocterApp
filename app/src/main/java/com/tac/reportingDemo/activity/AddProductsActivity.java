...
import com.tac.reportingDemo.adapter.AddProductAdapter;
...
public class AddProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AddProductAdapter(this, mList);
        ...
        mAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (sp.getBillingType().equals("chemist")) {
                    Intent intent = new Intent(AddProductsActivity.this, ChemistBillingActivity.class);
                    startActivity(intent);
                }
                else {
                    Intent intent = new Intent(AddProductsActivity.this, BillingActivity.class);
                    startActivity(intent);
                }
            }
        });
                ...
                try {
                    if (JsonParsor.isReqSuccesful(response)) {
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            pojo.setRate(data.getString("Rate"));
                            pojo.setMrp(data.getString("Mrp"));
                            mList.add(pojo);
                        }
