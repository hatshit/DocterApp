...
import com.tac.reportingDemo.adapter.EditSampleAdapter;
...
public class EditSampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit Samples");

        mRequestQue = MyVolley.getInstance().getRequestQueue();
        sp = MySharedPreferences.getInstance(this);

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new EditSampleAdapter(this, mList);

        mAddMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditSampleActivity.this, AddSampleActivity.class);
    ...
    public void fetchProducts() {
        try {
            ...
            List<String> productIds = new Gson().fromJson(sp.getSampleIds(), ArrayList.class);
            JSONObject dataArray = new JSONObject(sp.getSamples());
            mList.clear();
