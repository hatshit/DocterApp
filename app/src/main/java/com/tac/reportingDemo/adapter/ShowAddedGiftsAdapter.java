...
public class ShowAddedGiftsAdapter extends RecyclerView.Adapter<ShowAddedGiftsAdapter.MyViewHolder> {


    private Context context;
    private List<ProductPojo> mList;

    public ShowAddedGiftsAdapter(Context context, List<ProductPojo> mList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.gifts_list_layout,parent,false);
